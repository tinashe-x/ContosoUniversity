...
namespace ContosoUniversity.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new ContosoUniversityUser { UserName = Input.Email, Email = Input.Email , EmergencyContact = Input.EmergencyContact, EmergencyContactDetails = Input.EmergencyContactDetails };
